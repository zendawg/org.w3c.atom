 ...
 */
public class CaptionDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.w3.x1999.xhtml.CaptionDocument
{
     ...
     * This is a complex type.
     */
    public static class CaptionImpl extends org.w3.x1999.xhtml.impl.InlineImpl implements org.w3.x1999.xhtml.CaptionDocument.Caption
    {
        private static final long serialVersionUID = 1L;
         ...
         */
        public org.w3.x1999.xhtml.CaptionDocument.Caption.Dir.Enum getDir()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                return (org.w3.x1999.xhtml.CaptionDocument.Caption.Dir.Enum)target.getEnumValue();
            }
        }
         ...
         */
        public org.w3.x1999.xhtml.CaptionDocument.Caption.Dir xgetDir()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.w3.x1999.xhtml.CaptionDocument.Caption.Dir target = null;
                target = (org.w3.x1999.xhtml.CaptionDocument.Caption.Dir)get_store().find_attribute_user(DIR$12);
                return target;
            }
        }
         ...
         */
        public void setDir(org.w3.x1999.xhtml.CaptionDocument.Caption.Dir.Enum dir)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public void xsetDir(org.w3.x1999.xhtml.CaptionDocument.Caption.Dir dir)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (org.w3.x1999.xhtml.CaptionDocument.Caption.Dir)get_store().add_attribute_user(DIR$12);
                }
                target.set(dir);
            }
        }
         ...
         */
        public static class DirImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements org.w3.x1999.xhtml.CaptionDocument.Caption.Dir
        {
            private static final long serialVersionUID = 1L;
