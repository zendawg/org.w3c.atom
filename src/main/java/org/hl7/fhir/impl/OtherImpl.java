...
public class OtherImpl extends org.hl7.fhir.impl.ResourceImpl implements org.hl7.fhir.Other
{
    ...
    public org.hl7.fhir.Date getCreated()
    {
        synchronized (monitor())
        {
            ...
            target = (org.hl7.fhir.Date)get_store().find_element_user(CREATED$8, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetCreated()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(CREATED$8) != 0;
        }
    }
    ...
    {
        generatedSetterHelperImpl(created, CREATED$8, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public org.hl7.fhir.Date addNewCreated()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.hl7.fhir.Date target = null;
            target = (org.hl7.fhir.Date)get_store().add_element_user(CREATED$8);
            return target;
        }
    }
