 ...
 */
public class IDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.w3.x1999.xhtml.IDocument
{
    private static final long serialVersionUID = 1L;
    
    public IDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     * Gets the "i" element
     */
    public org.w3.x1999.xhtml.IDocument.I getI()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.w3.x1999.xhtml.IDocument.I target = null;
            target = (org.w3.x1999.xhtml.IDocument.I)get_store().find_element_user(I$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     * Sets the "i" element
     */
    public void setI(org.w3.x1999.xhtml.IDocument.I iValue)
    {
        generatedSetterHelperImpl(iValue, I$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public org.w3.x1999.xhtml.IDocument.I addNewI()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.w3.x1999.xhtml.IDocument.I target = null;
            target = (org.w3.x1999.xhtml.IDocument.I)get_store().add_element_user(I$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class IImpl extends org.w3.x1999.xhtml.impl.InlineImpl implements org.w3.x1999.xhtml.IDocument.I
    {
        private static final long serialVersionUID = 1L;
        
        public IImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
         ...
         */
        public org.w3.x1999.xhtml.IDocument.I.Dir.Enum getDir()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                return (org.w3.x1999.xhtml.IDocument.I.Dir.Enum)target.getEnumValue();
            }
        }
         ...
         */
        public org.w3.x1999.xhtml.IDocument.I.Dir xgetDir()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.w3.x1999.xhtml.IDocument.I.Dir target = null;
                target = (org.w3.x1999.xhtml.IDocument.I.Dir)get_store().find_attribute_user(DIR$12);
                return target;
            }
        }
         ...
         */
        public void setDir(org.w3.x1999.xhtml.IDocument.I.Dir.Enum dir)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public void xsetDir(org.w3.x1999.xhtml.IDocument.I.Dir dir)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (org.w3.x1999.xhtml.IDocument.I.Dir)get_store().add_attribute_user(DIR$12);
                }
                target.set(dir);
            }
        }
         ...
         */
        public static class DirImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements org.w3.x1999.xhtml.IDocument.I.Dir
        {
            private static final long serialVersionUID = 1L;
