 ...
 */
public class BDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.w3.x1999.xhtml.BDocument
{
    private static final long serialVersionUID = 1L;
    
    public BDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName B$0 = 
     ...
     * Gets the "b" element
     */
    public org.w3.x1999.xhtml.BDocument.B getB()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.w3.x1999.xhtml.BDocument.B target = null;
            target = (org.w3.x1999.xhtml.BDocument.B)get_store().find_element_user(B$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     * Sets the "b" element
     */
    public void setB(org.w3.x1999.xhtml.BDocument.B b)
    {
        generatedSetterHelperImpl(b, B$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public org.w3.x1999.xhtml.BDocument.B addNewB()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.w3.x1999.xhtml.BDocument.B target = null;
            target = (org.w3.x1999.xhtml.BDocument.B)get_store().add_element_user(B$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class BImpl extends org.w3.x1999.xhtml.impl.InlineImpl implements org.w3.x1999.xhtml.BDocument.B
    {
        private static final long serialVersionUID = 1L;
         ...
         */
        public org.w3.x1999.xhtml.BDocument.B.Dir.Enum getDir()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                return (org.w3.x1999.xhtml.BDocument.B.Dir.Enum)target.getEnumValue();
            }
        }
         ...
         */
        public org.w3.x1999.xhtml.BDocument.B.Dir xgetDir()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.w3.x1999.xhtml.BDocument.B.Dir target = null;
                target = (org.w3.x1999.xhtml.BDocument.B.Dir)get_store().find_attribute_user(DIR$12);
                return target;
            }
        }
         ...
         */
        public void setDir(org.w3.x1999.xhtml.BDocument.B.Dir.Enum dir)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public void xsetDir(org.w3.x1999.xhtml.BDocument.B.Dir dir)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (org.w3.x1999.xhtml.BDocument.B.Dir)get_store().add_attribute_user(DIR$12);
                }
                target.set(dir);
            }
        }
         ...
         */
        public static class DirImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements org.w3.x1999.xhtml.BDocument.B.Dir
        {
            private static final long serialVersionUID = 1L;
