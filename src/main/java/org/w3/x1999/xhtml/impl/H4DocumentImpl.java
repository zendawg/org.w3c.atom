 ...
 */
public class H4DocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.w3.x1999.xhtml.H4Document
{
     ...
     * Gets the "h4" element
     */
    public org.w3.x1999.xhtml.H4Document.H4 getH4()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.w3.x1999.xhtml.H4Document.H4 target = null;
            target = (org.w3.x1999.xhtml.H4Document.H4)get_store().find_element_user(H4$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     * Sets the "h4" element
     */
    public void setH4(org.w3.x1999.xhtml.H4Document.H4 h4)
    {
    ...
    public org.w3.x1999.xhtml.H4Document.H4 addNewH4()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.w3.x1999.xhtml.H4Document.H4 target = null;
            target = (org.w3.x1999.xhtml.H4Document.H4)get_store().add_element_user(H4$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class H4Impl extends org.w3.x1999.xhtml.impl.InlineImpl implements org.w3.x1999.xhtml.H4Document.H4
    {
        private static final long serialVersionUID = 1L;
         ...
         */
        public org.w3.x1999.xhtml.H4Document.H4.Dir.Enum getDir()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                return (org.w3.x1999.xhtml.H4Document.H4.Dir.Enum)target.getEnumValue();
            }
        }
         ...
         */
        public org.w3.x1999.xhtml.H4Document.H4.Dir xgetDir()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.w3.x1999.xhtml.H4Document.H4.Dir target = null;
                target = (org.w3.x1999.xhtml.H4Document.H4.Dir)get_store().find_attribute_user(DIR$12);
                return target;
            }
        }
         ...
         */
        public void setDir(org.w3.x1999.xhtml.H4Document.H4.Dir.Enum dir)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public void xsetDir(org.w3.x1999.xhtml.H4Document.H4.Dir dir)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (org.w3.x1999.xhtml.H4Document.H4.Dir)get_store().add_attribute_user(DIR$12);
                }
                target.set(dir);
            }
        }
         ...
         */
        public static class DirImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements org.w3.x1999.xhtml.H4Document.H4.Dir
        {
            private static final long serialVersionUID = 1L;
