 ...
 */
public class BlockquoteDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.w3.x1999.xhtml.BlockquoteDocument
{
    private static final long serialVersionUID = 1L;
    
    public BlockquoteDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public org.w3.x1999.xhtml.BlockquoteDocument.Blockquote getBlockquote()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.w3.x1999.xhtml.BlockquoteDocument.Blockquote target = null;
            target = (org.w3.x1999.xhtml.BlockquoteDocument.Blockquote)get_store().find_element_user(BLOCKQUOTE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setBlockquote(org.w3.x1999.xhtml.BlockquoteDocument.Blockquote blockquote)
    {
        generatedSetterHelperImpl(blockquote, BLOCKQUOTE$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public org.w3.x1999.xhtml.BlockquoteDocument.Blockquote addNewBlockquote()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.w3.x1999.xhtml.BlockquoteDocument.Blockquote target = null;
            target = (org.w3.x1999.xhtml.BlockquoteDocument.Blockquote)get_store().add_element_user(BLOCKQUOTE$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class BlockquoteImpl extends org.w3.x1999.xhtml.impl.BlockImpl implements org.w3.x1999.xhtml.BlockquoteDocument.Blockquote
    {
        private static final long serialVersionUID = 1L;
        
        public BlockquoteImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
        ...
        private static final javax.xml.namespace.QName CITE$34 = 
         ...
         */
        public org.w3.x1999.xhtml.BlockquoteDocument.Blockquote.Dir.Enum getDir()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                return (org.w3.x1999.xhtml.BlockquoteDocument.Blockquote.Dir.Enum)target.getEnumValue();
            }
        }
         ...
         */
        public org.w3.x1999.xhtml.BlockquoteDocument.Blockquote.Dir xgetDir()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.w3.x1999.xhtml.BlockquoteDocument.Blockquote.Dir target = null;
                target = (org.w3.x1999.xhtml.BlockquoteDocument.Blockquote.Dir)get_store().find_attribute_user(DIR$12);
                return target;
            }
        }
         ...
         */
        public void setDir(org.w3.x1999.xhtml.BlockquoteDocument.Blockquote.Dir.Enum dir)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public void xsetDir(org.w3.x1999.xhtml.BlockquoteDocument.Blockquote.Dir dir)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (org.w3.x1999.xhtml.BlockquoteDocument.Blockquote.Dir)get_store().add_attribute_user(DIR$12);
                }
                target.set(dir);
            }
        }
        ...
        public java.lang.String getCite()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.SimpleValue target = null;
                target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(CITE$34);
                if (target == null)
                {
                    return null;
                }
         ...
         */
        public org.w3.x1999.xhtml.URI xgetCite()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.w3.x1999.xhtml.URI target = null;
                target = (org.w3.x1999.xhtml.URI)get_store().find_attribute_user(CITE$34);
                return target;
            }
        }
        ...
        public boolean isSetCite()
        {
            ...
            {
                check_orphaned();
                return get_store().find_attribute_user(CITE$34) != null;
            }
        }
        ...
        public void setCite(java.lang.String cite)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(CITE$34);
                }
                target.setStringValue(cite);
            }
        }
         ...
         */
        public void xsetCite(org.w3.x1999.xhtml.URI cite)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (org.w3.x1999.xhtml.URI)get_store().add_attribute_user(CITE$34);
                }
                target.set(cite);
            }
        }
         ...
         */
        public void unsetCite()
        {
            synchronized (monitor())
            {
                check_orphaned();
                get_store().remove_attribute(CITE$34);
            }
        }
        /**
         * An XML dir(@).
         ...
         */
        public static class DirImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements org.w3.x1999.xhtml.BlockquoteDocument.Blockquote.Dir
        {
            private static final long serialVersionUID = 1L;
