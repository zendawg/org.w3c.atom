 ...
 */
public class H6DocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.w3.x1999.xhtml.H6Document
{
     ...
     * Gets the "h6" element
     */
    public org.w3.x1999.xhtml.H6Document.H6 getH6()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.w3.x1999.xhtml.H6Document.H6 target = null;
            target = (org.w3.x1999.xhtml.H6Document.H6)get_store().find_element_user(H6$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     * Sets the "h6" element
     */
    public void setH6(org.w3.x1999.xhtml.H6Document.H6 h6)
    {
    ...
    public org.w3.x1999.xhtml.H6Document.H6 addNewH6()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.w3.x1999.xhtml.H6Document.H6 target = null;
            target = (org.w3.x1999.xhtml.H6Document.H6)get_store().add_element_user(H6$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class H6Impl extends org.w3.x1999.xhtml.impl.InlineImpl implements org.w3.x1999.xhtml.H6Document.H6
    {
        private static final long serialVersionUID = 1L;
         ...
         */
        public org.w3.x1999.xhtml.H6Document.H6.Dir.Enum getDir()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                return (org.w3.x1999.xhtml.H6Document.H6.Dir.Enum)target.getEnumValue();
            }
        }
         ...
         */
        public org.w3.x1999.xhtml.H6Document.H6.Dir xgetDir()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.w3.x1999.xhtml.H6Document.H6.Dir target = null;
                target = (org.w3.x1999.xhtml.H6Document.H6.Dir)get_store().find_attribute_user(DIR$12);
                return target;
            }
        }
         ...
         */
        public void setDir(org.w3.x1999.xhtml.H6Document.H6.Dir.Enum dir)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public void xsetDir(org.w3.x1999.xhtml.H6Document.H6.Dir dir)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (org.w3.x1999.xhtml.H6Document.H6.Dir)get_store().add_attribute_user(DIR$12);
                }
                target.set(dir);
            }
        }
         ...
         */
        public static class DirImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements org.w3.x1999.xhtml.H6Document.H6.Dir
        {
            private static final long serialVersionUID = 1L;
