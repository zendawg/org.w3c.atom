 ...
 */
public class PDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.w3.x1999.xhtml.PDocument
{
     ...
     * Gets the "p" element
     */
    public org.w3.x1999.xhtml.PDocument.P getP()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.w3.x1999.xhtml.PDocument.P target = null;
            target = (org.w3.x1999.xhtml.PDocument.P)get_store().find_element_user(P$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     * Sets the "p" element
     */
    public void setP(org.w3.x1999.xhtml.PDocument.P p)
    {
     ...
     * This is a complex type.
     */
    public static class PImpl extends org.w3.x1999.xhtml.impl.InlineImpl implements org.w3.x1999.xhtml.PDocument.P
    {
        private static final long serialVersionUID = 1L;
         ...
         */
        public org.w3.x1999.xhtml.PDocument.P.Dir.Enum getDir()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                return (org.w3.x1999.xhtml.PDocument.P.Dir.Enum)target.getEnumValue();
            }
        }
         ...
         */
        public org.w3.x1999.xhtml.PDocument.P.Dir xgetDir()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.w3.x1999.xhtml.PDocument.P.Dir target = null;
                target = (org.w3.x1999.xhtml.PDocument.P.Dir)get_store().find_attribute_user(DIR$12);
                return target;
            }
        }
         ...
         */
        public void setDir(org.w3.x1999.xhtml.PDocument.P.Dir.Enum dir)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public void xsetDir(org.w3.x1999.xhtml.PDocument.P.Dir dir)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (org.w3.x1999.xhtml.PDocument.P.Dir)get_store().add_attribute_user(DIR$12);
                }
                target.set(dir);
            }
        }
         ...
         */
        public static class DirImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements org.w3.x1999.xhtml.PDocument.P.Dir
        {
            private static final long serialVersionUID = 1L;
