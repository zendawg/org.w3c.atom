 ...
 */
public class BodyDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.w3.x1999.xhtml.BodyDocument
{
    ...
    public org.w3.x1999.xhtml.BodyDocument.Body getBody()
    {
        synchronized (monitor())
        {
            ...
            target = (org.w3.x1999.xhtml.BodyDocument.Body)get_store().find_element_user(BODY$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(body, BODY$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public org.w3.x1999.xhtml.BodyDocument.Body addNewBody()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.w3.x1999.xhtml.BodyDocument.Body target = null;
            target = (org.w3.x1999.xhtml.BodyDocument.Body)get_store().add_element_user(BODY$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class BodyImpl extends org.w3.x1999.xhtml.impl.BlockImpl implements org.w3.x1999.xhtml.BodyDocument.Body
    {
        private static final long serialVersionUID = 1L;
        ...
        private static final javax.xml.namespace.QName ONLOAD$34 = 
            new javax.xml.namespace.QName("", "onload");
        private static final javax.xml.namespace.QName ONUNLOAD$36 = 
            new javax.xml.namespace.QName("", "onunload");
         ...
         */
        public org.w3.x1999.xhtml.BodyDocument.Body.Dir.Enum getDir()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                return (org.w3.x1999.xhtml.BodyDocument.Body.Dir.Enum)target.getEnumValue();
            }
        }
         ...
         */
        public org.w3.x1999.xhtml.BodyDocument.Body.Dir xgetDir()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.w3.x1999.xhtml.BodyDocument.Body.Dir target = null;
                target = (org.w3.x1999.xhtml.BodyDocument.Body.Dir)get_store().find_attribute_user(DIR$12);
                return target;
            }
        }
         ...
         */
        public void setDir(org.w3.x1999.xhtml.BodyDocument.Body.Dir.Enum dir)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public void xsetDir(org.w3.x1999.xhtml.BodyDocument.Body.Dir dir)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (org.w3.x1999.xhtml.BodyDocument.Body.Dir)get_store().add_attribute_user(DIR$12);
                }
                target.set(dir);
            }
        }
        ...
        public java.lang.String getOnload()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.SimpleValue target = null;
                target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(ONLOAD$34);
                if (target == null)
                {
                    return null;
                }
         ...
         */
        public org.w3.x1999.xhtml.Script xgetOnload()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.w3.x1999.xhtml.Script target = null;
                target = (org.w3.x1999.xhtml.Script)get_store().find_attribute_user(ONLOAD$34);
                return target;
            }
        }
        ...
        public boolean isSetOnload()
        {
            ...
            {
                check_orphaned();
                return get_store().find_attribute_user(ONLOAD$34) != null;
            }
        }
        ...
        public void setOnload(java.lang.String onload)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(ONLOAD$34);
                }
                target.setStringValue(onload);
            }
        }
         ...
         */
        public void xsetOnload(org.w3.x1999.xhtml.Script onload)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (org.w3.x1999.xhtml.Script)get_store().add_attribute_user(ONLOAD$34);
                }
                target.set(onload);
            }
        }
        ...
        public void unsetOnload()
        {
            ...
            {
                check_orphaned();
                get_store().remove_attribute(ONLOAD$34);
            }
        }
        ...
        public java.lang.String getOnunload()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.SimpleValue target = null;
                target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(ONUNLOAD$36);
                if (target == null)
                {
                    return null;
                }
         ...
         */
        public org.w3.x1999.xhtml.Script xgetOnunload()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.w3.x1999.xhtml.Script target = null;
                target = (org.w3.x1999.xhtml.Script)get_store().find_attribute_user(ONUNLOAD$36);
                return target;
            }
        }
        ...
        public boolean isSetOnunload()
        {
            ...
            {
                check_orphaned();
                return get_store().find_attribute_user(ONUNLOAD$36) != null;
            }
        }
        ...
        public void setOnunload(java.lang.String onunload)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(ONUNLOAD$36);
                }
                target.setStringValue(onunload);
            }
        }
         ...
         */
        public void xsetOnunload(org.w3.x1999.xhtml.Script onunload)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (org.w3.x1999.xhtml.Script)get_store().add_attribute_user(ONUNLOAD$36);
                }
                target.set(onunload);
            }
        }
         ...
         */
        public void unsetOnunload()
        {
            synchronized (monitor())
            {
                check_orphaned();
                get_store().remove_attribute(ONUNLOAD$36);
            }
        }
        /**
         * An XML dir(@).
         ...
         */
        public static class DirImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements org.w3.x1999.xhtml.BodyDocument.Body.Dir
        {
            private static final long serialVersionUID = 1L;
