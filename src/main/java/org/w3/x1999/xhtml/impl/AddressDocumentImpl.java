 ...
 */
public class AddressDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.w3.x1999.xhtml.AddressDocument
{
     ...
     */
    public org.w3.x1999.xhtml.AddressDocument.Address getAddress()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.w3.x1999.xhtml.AddressDocument.Address target = null;
            target = (org.w3.x1999.xhtml.AddressDocument.Address)get_store().find_element_user(ADDRESS$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setAddress(org.w3.x1999.xhtml.AddressDocument.Address address)
    {
    ...
    public org.w3.x1999.xhtml.AddressDocument.Address addNewAddress()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.w3.x1999.xhtml.AddressDocument.Address target = null;
            target = (org.w3.x1999.xhtml.AddressDocument.Address)get_store().add_element_user(ADDRESS$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class AddressImpl extends org.w3.x1999.xhtml.impl.InlineImpl implements org.w3.x1999.xhtml.AddressDocument.Address
    {
        private static final long serialVersionUID = 1L;
         ...
         */
        public org.w3.x1999.xhtml.AddressDocument.Address.Dir.Enum getDir()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                return (org.w3.x1999.xhtml.AddressDocument.Address.Dir.Enum)target.getEnumValue();
            }
        }
         ...
         */
        public org.w3.x1999.xhtml.AddressDocument.Address.Dir xgetDir()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.w3.x1999.xhtml.AddressDocument.Address.Dir target = null;
                target = (org.w3.x1999.xhtml.AddressDocument.Address.Dir)get_store().find_attribute_user(DIR$12);
                return target;
            }
        }
         ...
         */
        public void setDir(org.w3.x1999.xhtml.AddressDocument.Address.Dir.Enum dir)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public void xsetDir(org.w3.x1999.xhtml.AddressDocument.Address.Dir dir)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (org.w3.x1999.xhtml.AddressDocument.Address.Dir)get_store().add_attribute_user(DIR$12);
                }
                target.set(dir);
            }
        }
         ...
         */
        public static class DirImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements org.w3.x1999.xhtml.AddressDocument.Address.Dir
        {
            private static final long serialVersionUID = 1L;
