 ...
 */
public class H5DocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.w3.x1999.xhtml.H5Document
{
     ...
     * Gets the "h5" element
     */
    public org.w3.x1999.xhtml.H5Document.H5 getH5()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.w3.x1999.xhtml.H5Document.H5 target = null;
            target = (org.w3.x1999.xhtml.H5Document.H5)get_store().find_element_user(H5$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     * Sets the "h5" element
     */
    public void setH5(org.w3.x1999.xhtml.H5Document.H5 h5)
    {
    ...
    public org.w3.x1999.xhtml.H5Document.H5 addNewH5()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.w3.x1999.xhtml.H5Document.H5 target = null;
            target = (org.w3.x1999.xhtml.H5Document.H5)get_store().add_element_user(H5$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class H5Impl extends org.w3.x1999.xhtml.impl.InlineImpl implements org.w3.x1999.xhtml.H5Document.H5
    {
        private static final long serialVersionUID = 1L;
         ...
         */
        public org.w3.x1999.xhtml.H5Document.H5.Dir.Enum getDir()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                return (org.w3.x1999.xhtml.H5Document.H5.Dir.Enum)target.getEnumValue();
            }
        }
         ...
         */
        public org.w3.x1999.xhtml.H5Document.H5.Dir xgetDir()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.w3.x1999.xhtml.H5Document.H5.Dir target = null;
                target = (org.w3.x1999.xhtml.H5Document.H5.Dir)get_store().find_attribute_user(DIR$12);
                return target;
            }
        }
         ...
         */
        public void setDir(org.w3.x1999.xhtml.H5Document.H5.Dir.Enum dir)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public void xsetDir(org.w3.x1999.xhtml.H5Document.H5.Dir dir)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (org.w3.x1999.xhtml.H5Document.H5.Dir)get_store().add_attribute_user(DIR$12);
                }
                target.set(dir);
            }
        }
         ...
         */
        public static class DirImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements org.w3.x1999.xhtml.H5Document.H5.Dir
        {
            private static final long serialVersionUID = 1L;
