 ...
 */
public class LiDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.w3.x1999.xhtml.LiDocument
{
     ...
     * Gets the "li" element
     */
    public org.w3.x1999.xhtml.LiDocument.Li getLi()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.w3.x1999.xhtml.LiDocument.Li target = null;
            target = (org.w3.x1999.xhtml.LiDocument.Li)get_store().find_element_user(LI$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     * Sets the "li" element
     */
    public void setLi(org.w3.x1999.xhtml.LiDocument.Li li)
    {
     ...
     * This is a complex type.
     */
    public static class LiImpl extends org.w3.x1999.xhtml.impl.FlowImpl implements org.w3.x1999.xhtml.LiDocument.Li
    {
        private static final long serialVersionUID = 1L;
         ...
         */
        public org.w3.x1999.xhtml.LiDocument.Li.Dir.Enum getDir()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                return (org.w3.x1999.xhtml.LiDocument.Li.Dir.Enum)target.getEnumValue();
            }
        }
         ...
         */
        public org.w3.x1999.xhtml.LiDocument.Li.Dir xgetDir()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.w3.x1999.xhtml.LiDocument.Li.Dir target = null;
                target = (org.w3.x1999.xhtml.LiDocument.Li.Dir)get_store().find_attribute_user(DIR$12);
                return target;
            }
        }
         ...
         */
        public void setDir(org.w3.x1999.xhtml.LiDocument.Li.Dir.Enum dir)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public void xsetDir(org.w3.x1999.xhtml.LiDocument.Li.Dir dir)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (org.w3.x1999.xhtml.LiDocument.Li.Dir)get_store().add_attribute_user(DIR$12);
                }
                target.set(dir);
            }
        }
         ...
         */
        public static class DirImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements org.w3.x1999.xhtml.LiDocument.Li.Dir
        {
            private static final long serialVersionUID = 1L;
