 ...
 */
public class MedicationIngredientImpl extends org.hl7.fhir.impl.BackboneElementImpl implements org.hl7.fhir.MedicationIngredient
{
    private static final long serialVersionUID = 1L;
    
    public MedicationIngredientImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public org.hl7.fhir.Ratio getAmount()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.hl7.fhir.Ratio target = null;
            target = (org.hl7.fhir.Ratio)get_store().find_element_user(AMOUNT$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setAmount(org.hl7.fhir.Ratio amount)
    {
     ...
     */
    public org.hl7.fhir.Ratio addNewAmount()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.hl7.fhir.Ratio target = null;
            target = (org.hl7.fhir.Ratio)get_store().add_element_user(AMOUNT$2);
            return target;
        }
    }
