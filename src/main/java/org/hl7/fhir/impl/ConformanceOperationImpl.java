 ...
 */
public class ConformanceOperationImpl extends org.hl7.fhir.impl.BackboneElementImpl implements org.hl7.fhir.ConformanceOperation
{
    private static final long serialVersionUID = 1L;
    
    public ConformanceOperationImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public org.hl7.fhir.RestfulOperationType getCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.hl7.fhir.RestfulOperationType target = null;
            target = (org.hl7.fhir.RestfulOperationType)get_store().find_element_user(CODE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setCode(org.hl7.fhir.RestfulOperationType code)
    {
     ...
     */
    public org.hl7.fhir.RestfulOperationType addNewCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.hl7.fhir.RestfulOperationType target = null;
            target = (org.hl7.fhir.RestfulOperationType)get_store().add_element_user(CODE$0);
            return target;
        }
    }
