 ...
 */
public class DelDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.w3.x1999.xhtml.DelDocument
{
    private static final long serialVersionUID = 1L;
    
    public DelDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName DEL$0 = 
     ...
     */
    public org.w3.x1999.xhtml.DelDocument.Del getDel()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.w3.x1999.xhtml.DelDocument.Del target = null;
            target = (org.w3.x1999.xhtml.DelDocument.Del)get_store().find_element_user(DEL$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setDel(org.w3.x1999.xhtml.DelDocument.Del del)
    {
        generatedSetterHelperImpl(del, DEL$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public org.w3.x1999.xhtml.DelDocument.Del addNewDel()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.w3.x1999.xhtml.DelDocument.Del target = null;
            target = (org.w3.x1999.xhtml.DelDocument.Del)get_store().add_element_user(DEL$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class DelImpl extends org.w3.x1999.xhtml.impl.FlowImpl implements org.w3.x1999.xhtml.DelDocument.Del
    {
        private static final long serialVersionUID = 1L;
        
        public DelImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
        ...
        private static final javax.xml.namespace.QName CITE2$34 = 
            new javax.xml.namespace.QName("", "cite");
        private static final javax.xml.namespace.QName DATETIME$36 = 
         ...
         */
        public org.w3.x1999.xhtml.DelDocument.Del.Dir.Enum getDir()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                return (org.w3.x1999.xhtml.DelDocument.Del.Dir.Enum)target.getEnumValue();
            }
        }
         ...
         */
        public org.w3.x1999.xhtml.DelDocument.Del.Dir xgetDir()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.w3.x1999.xhtml.DelDocument.Del.Dir target = null;
                target = (org.w3.x1999.xhtml.DelDocument.Del.Dir)get_store().find_attribute_user(DIR$12);
                return target;
            }
        }
         ...
         */
        public void setDir(org.w3.x1999.xhtml.DelDocument.Del.Dir.Enum dir)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public void xsetDir(org.w3.x1999.xhtml.DelDocument.Del.Dir dir)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (org.w3.x1999.xhtml.DelDocument.Del.Dir)get_store().add_attribute_user(DIR$12);
                }
                target.set(dir);
            }
        }
         ...
         */
        public java.lang.String getCite2()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.SimpleValue target = null;
                target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(CITE2$34);
                if (target == null)
                {
                    return null;
                }
         ...
         */
        public org.w3.x1999.xhtml.URI xgetCite2()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.w3.x1999.xhtml.URI target = null;
                target = (org.w3.x1999.xhtml.URI)get_store().find_attribute_user(CITE2$34);
                return target;
            }
        }
         ...
         */
        public boolean isSetCite2()
        {
            synchronized (monitor())
            {
                check_orphaned();
                return get_store().find_attribute_user(CITE2$34) != null;
            }
        }
         ...
         */
        public void setCite2(java.lang.String cite2)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(CITE2$34);
                }
                target.setStringValue(cite2);
            }
        }
         ...
         */
        public void xsetCite2(org.w3.x1999.xhtml.URI cite2)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (org.w3.x1999.xhtml.URI)get_store().add_attribute_user(CITE2$34);
                }
                target.set(cite2);
            }
        }
         ...
         */
        public void unsetCite2()
        {
            synchronized (monitor())
            {
                check_orphaned();
                get_store().remove_attribute(CITE2$34);
            }
        }
        ...
        public java.util.Calendar getDatetime()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.SimpleValue target = null;
                target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(DATETIME$36);
                if (target == null)
                {
                    return null;
                }
         ...
         */
        public org.w3.x1999.xhtml.Datetime xgetDatetime()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.w3.x1999.xhtml.Datetime target = null;
                target = (org.w3.x1999.xhtml.Datetime)get_store().find_attribute_user(DATETIME$36);
                return target;
            }
        }
        ...
        public boolean isSetDatetime()
        {
            ...
            {
                check_orphaned();
                return get_store().find_attribute_user(DATETIME$36) != null;
            }
        }
        ...
        public void setDatetime(java.util.Calendar datetime)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(DATETIME$36);
                }
         ...
         */
        public void xsetDatetime(org.w3.x1999.xhtml.Datetime datetime)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (org.w3.x1999.xhtml.Datetime)get_store().add_attribute_user(DATETIME$36);
                }
                target.set(datetime);
            }
        }
        ...
        public void unsetDatetime()
        {
            ...
            {
                check_orphaned();
                get_store().remove_attribute(DATETIME$36);
            }
        }
        /**
         * An XML dir(@).
         ...
         */
        public static class DirImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements org.w3.x1999.xhtml.DelDocument.Del.Dir
        {
            private static final long serialVersionUID = 1L;
