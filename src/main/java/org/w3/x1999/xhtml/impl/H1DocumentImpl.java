 ...
 */
public class H1DocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.w3.x1999.xhtml.H1Document
{
    private static final long serialVersionUID = 1L;
    
    public H1DocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName H1$0 = 
     ...
     * Gets the "h1" element
     */
    public org.w3.x1999.xhtml.H1Document.H1 getH1()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.w3.x1999.xhtml.H1Document.H1 target = null;
            target = (org.w3.x1999.xhtml.H1Document.H1)get_store().find_element_user(H1$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     * Sets the "h1" element
     */
    public void setH1(org.w3.x1999.xhtml.H1Document.H1 h1)
    {
        generatedSetterHelperImpl(h1, H1$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public org.w3.x1999.xhtml.H1Document.H1 addNewH1()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.w3.x1999.xhtml.H1Document.H1 target = null;
            target = (org.w3.x1999.xhtml.H1Document.H1)get_store().add_element_user(H1$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class H1Impl extends org.w3.x1999.xhtml.impl.InlineImpl implements org.w3.x1999.xhtml.H1Document.H1
    {
        private static final long serialVersionUID = 1L;
        
        public H1Impl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
         ...
         */
        public org.w3.x1999.xhtml.H1Document.H1.Dir.Enum getDir()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                return (org.w3.x1999.xhtml.H1Document.H1.Dir.Enum)target.getEnumValue();
            }
        }
         ...
         */
        public org.w3.x1999.xhtml.H1Document.H1.Dir xgetDir()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.w3.x1999.xhtml.H1Document.H1.Dir target = null;
                target = (org.w3.x1999.xhtml.H1Document.H1.Dir)get_store().find_attribute_user(DIR$12);
                return target;
            }
        }
         ...
         */
        public void setDir(org.w3.x1999.xhtml.H1Document.H1.Dir.Enum dir)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public void xsetDir(org.w3.x1999.xhtml.H1Document.H1.Dir dir)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (org.w3.x1999.xhtml.H1Document.H1.Dir)get_store().add_attribute_user(DIR$12);
                }
                target.set(dir);
            }
        }
         ...
         */
        public static class DirImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements org.w3.x1999.xhtml.H1Document.H1.Dir
        {
            private static final long serialVersionUID = 1L;
