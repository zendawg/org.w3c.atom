 ...
 */
public class H3DocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.w3.x1999.xhtml.H3Document
{
     ...
     * Gets the "h3" element
     */
    public org.w3.x1999.xhtml.H3Document.H3 getH3()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.w3.x1999.xhtml.H3Document.H3 target = null;
            target = (org.w3.x1999.xhtml.H3Document.H3)get_store().find_element_user(H3$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     * Sets the "h3" element
     */
    public void setH3(org.w3.x1999.xhtml.H3Document.H3 h3)
    {
    ...
    public org.w3.x1999.xhtml.H3Document.H3 addNewH3()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.w3.x1999.xhtml.H3Document.H3 target = null;
            target = (org.w3.x1999.xhtml.H3Document.H3)get_store().add_element_user(H3$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class H3Impl extends org.w3.x1999.xhtml.impl.InlineImpl implements org.w3.x1999.xhtml.H3Document.H3
    {
        private static final long serialVersionUID = 1L;
         ...
         */
        public org.w3.x1999.xhtml.H3Document.H3.Dir.Enum getDir()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                return (org.w3.x1999.xhtml.H3Document.H3.Dir.Enum)target.getEnumValue();
            }
        }
         ...
         */
        public org.w3.x1999.xhtml.H3Document.H3.Dir xgetDir()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.w3.x1999.xhtml.H3Document.H3.Dir target = null;
                target = (org.w3.x1999.xhtml.H3Document.H3.Dir)get_store().find_attribute_user(DIR$12);
                return target;
            }
        }
         ...
         */
        public void setDir(org.w3.x1999.xhtml.H3Document.H3.Dir.Enum dir)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public void xsetDir(org.w3.x1999.xhtml.H3Document.H3.Dir dir)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (org.w3.x1999.xhtml.H3Document.H3.Dir)get_store().add_attribute_user(DIR$12);
                }
                target.set(dir);
            }
        }
         ...
         */
        public static class DirImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements org.w3.x1999.xhtml.H3Document.H3.Dir
        {
            private static final long serialVersionUID = 1L;
